...
知识库：100 条 JD → 243 个 chunks，15 道测试题

| 策略 | P@5 | R@5 | MRR | NDCG@5 |
|------|:---:|:---:|:---:|:---:|
| 纯向量 Vector | 0.43 | 0.33 | 0.46 | 0.35 |
| 纯 BM25 | 0.41 | 0.29 | 0.47 | 0.34 |
| + RRF 融合 | 0.43 | 0.34 | 0.45 | 0.34 |
| **+ Reranker 精排** | **0.44** | **0.39** | 0.45 | **0.35** |

> 完整管线（+Reranker）在 P@5 和 R@5 上均优于纯向量和纯 BM25。随着知识库规模增长，混合检索 + 精排的优势会更显著。
