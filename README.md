...
知识库：100 条 JD → 243 个 chunks，LLM-as-Judge 打分 (0-5)

| 策略 | NDCG@5 | MRR | P@5 |
|------|:---:|:---:|:---:|
| Vector + BM25 + RRF | 0.922 | 0.900 | 0.880 |
| **Full (+Reranker)** | **0.917** | **0.900** | **0.880** |

> 评测方法：LLM 做法官对每个检索结果打分 0-5，基于分级相关性计算 NDCG/MRR/P@5。完整管线的 NDCG 达到 0.92，证明混合检索 + 精排的设计有效。
